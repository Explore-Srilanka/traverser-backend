...
export class PlacesSeed {
  ...
  public async getMockPlaces() {
    const places = [
      ...
      },
      {
        ...
        image:
          'https://d2r2v0jxjsbm0p.cloudfront.net/2022/05/peacok-1000x900-1-1.jpg',
      },
      {
        name: 'Ramboda Falls',
        ...
        description:
          'Cascading down two tiers of rock is the mesmerising sight of stark white water-dropping 358 ft into a rocky pool. This is the 11th highest waterfall in Sri Lanka and is definitely worth seeing.',
        image:
          'https://d2r2v0jxjsbm0p.cloudfront.net/2022/05/ramboda-1000x900-2.jpg',
      },
      {
        ...
        longitude: '80.216797',
        description:
          'The story of the Galle Dutch Fort; a UNESCO World Heritage Site reverberates through every traveller’s photos and captions',
        image:
          'https://d2r2v0jxjsbm0p.cloudfront.net/2020/10/Galle-fort-02.jpg',
      },
      {
        ...
        longitude: '6.4381426',
        description:
          'Embark on a thrilling wildlife safari in Udawalawe National Park and be prepared for an adventure of a lifetime. Known to be the best place to spot Sri Lanka’s most treasured giants',
        image:
          'https://d2r2v0jxjsbm0p.cloudfront.net/2020/10/Udawalawe-elephant-sanctuary-1.jpg',
      },
    ];
    return places;
  }
  ...
  public async getRandomCategory() {
    ...
    while (shuffeledArray.length <= categoriesArray.length) {
      for (const _ of categoriesArray) {
      ...
      if (shuffeledArray.length === categoriesArray.length) break;
    }
